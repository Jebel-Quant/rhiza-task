...
uvx rhiza-task@1.8.0 print COVERAGE_FAIL_UNDER   # either spelling
```
...
```bash
RHIZA_CI_OS_MATRIX= uvx rhiza-task@1.8.0 ci-os-matrix   # still the default
```
...
```bash
RHIZA_LAYERS=rust uvx rhiza-task@1.8.0 test
```
