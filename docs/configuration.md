...
uvx rhiza-task@1.4.1 print COVERAGE_FAIL_UNDER   # either spelling
```
...
```bash
RHIZA_CI_OS_MATRIX= uvx rhiza-task@1.4.1 ci-os-matrix   # still the default
```
...
```bash
RHIZA_LAYERS=rust uvx rhiza-task@1.4.1 test
```
